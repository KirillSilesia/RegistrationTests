...
def test_change_career_advisor_invalid_data(driver_with_login):
    ...
    career_advisor_page.invalid_first_field()
    career_advisor_page.select_second_field()
    career_advisor_page.invalid_second_field()
    ...
    career_advisor_page.select_fifteenth_field()
    career_advisor_page.invalid_fifteenth_field()
    career_advisor_page.select_sixteenth_radio()
    career_advisor_page.select_seventeenth_field()
    career_advisor_page.invalid_seventeenth_field()
    career_advisor_page.select_eighteenth_radio()
    career_advisor_page.submit_career_advisor_changes()
    assert career_advisor_page.is_failed() is True
...
def test_change_career_advisor_valid_data(driver_with_login):
    ...
    career_advisor_page.select_fourteenth_radio()
    career_advisor_page.select_fifteenth_field()
    career_advisor_page.valid_fifteenth_field()
    career_advisor_page.select_sixteenth_radio()
    career_advisor_page.select_seventeenth_field()
